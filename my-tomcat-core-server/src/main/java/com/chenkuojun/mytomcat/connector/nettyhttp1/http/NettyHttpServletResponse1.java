package com.chenkuojun.mytomcat.connector.nettyhttp1.http;

import com.chenkuojun.mytomcat.connector.nettyhttp.context.NettyEmbeddedContext;
import com.chenkuojun.mytomcat.connector.nettyhttp.http.HttpResponseOutputStream;
...
public class NettyHttpServletResponse1 implements HttpServletResponse {
    ...
    private HttpResponseOutputStream1 outputStream;
    ...
    public NettyHttpServletResponse1(ChannelHandlerContext ctx, HttpResponse response) {
        //this.servletContext = servletContext;
        this.response = response;
        this.outputStream = new HttpResponseOutputStream1(ctx, this);
    ...
    public HttpResponse getNettyResponse() {
        ...
        if (null != contentType) {
            String value = null == characterEncoding ? "text/html" : "text/html" + "; charset=" + characterEncoding;
