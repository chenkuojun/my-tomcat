...
import com.chenkuojun.mytomcat.connector.nettyhttp.http.HttpPostRequestParameters;
...
public class NettyHttpServletRequest1 implements HttpServletRequest {
    ...
    public NettyHttpServletRequest1(ChannelHandlerContext ctx, HttpRequest request,
        ...
        if (HttpMethod.POST.equals(request.getMethod())) {
            if (request instanceof FullHttpRequest) {
                HttpPostRequestParameters1 httpPostRequestParameters = new HttpPostRequestParameters1(
                                                                                                    request,
