package com.chenkuojun.mytomcat.connector.nettyhttp1.context;
...
@Slf4j
public class NettyEmbeddedContext1 implements ServletContext {
    ...
    public NettyEmbeddedContext1(String contextPath, ClassLoader classLoader, String serverInfo) {
    ...
    public URL getResource(String path) throws MalformedURLException {
        return NettyEmbeddedContext1.class.getResource(path);
    }

    @Override
    public InputStream getResourceAsStream(String path) {
        return NettyEmbeddedContext1.class.getResourceAsStream(path);
    }
