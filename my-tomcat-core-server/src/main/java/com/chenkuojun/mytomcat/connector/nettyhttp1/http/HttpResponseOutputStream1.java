...
public class HttpResponseOutputStream1 extends ServletOutputStream {

    private static final int               DEFAULT_BUFFER_SIZE = 1024 * 8;

    private final ChannelHandlerContext    ctx;
    private final NettyHttpServletResponse1 servletResponse;
    private byte[]                         buf;
    private int                            count;
    private boolean                        closed;
    private WriteListener                  writeListener;

    public HttpResponseOutputStream1(ChannelHandlerContext ctx, NettyHttpServletResponse1 servletResponse) {
        this.ctx = ctx;
