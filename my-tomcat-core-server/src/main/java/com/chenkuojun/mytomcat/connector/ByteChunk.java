...
import com.chenkuojun.mytomcat.utils.Ascii;
import com.chenkuojun.mytomcat.utils.StringCache;
...
public final class ByteChunk extends AbstractChunk {
    ...
    public void flushBuffer() throws IOException {
        // assert out!=null
        if (out == null) {
            throw new BufferOverflowException("chunk.overflow"+ Integer.valueOf(getLimit())+ Integer.valueOf(buff.length));
        }
