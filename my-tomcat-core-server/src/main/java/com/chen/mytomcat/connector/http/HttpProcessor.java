...
import com.chen.mytomcat.constant.Constants;
import com.chen.mytomcat.processor.ServletProcessor;
import com.chen.mytomcat.processor.StaticResourceProcessor;
import com.chen.mytomcat.utils.RequestUtil;
...
public class HttpProcessor {
  ...
  public void process(Socket socket) {
    ...
    try {
      ...
      if (request.getRequestURI().startsWith(Constants.SERVLET_PATH)) {
